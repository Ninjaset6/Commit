                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="panel-group" id="accordion">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" data-parent="#accordion" href="#Req1">
												<table width="100%">
													<tr>
														<td><i class="fa fa-tasks fa-fw"></i>Request#</td>
														<td><i class="fa fa-calendar fa-fw"></i>Posted Date</td>
														<td><i class="fa fa-heart fa-fw"></i>No of Support</td>
														<td><i class="fa fa-comment fa-fw"></i>No of Comment</td>
														<td><i class="fa fa-bar-chart-o fa-fw"></i>Ranking</td>
													</tr>
												</table>
											</a>
                                        </h4>
                                    </div>
                                    <div id="Req1" class="panel-collapse collapse in">
                                        <div class="panel-body">
											<table width="100%">
												<tr>
													<td><i>Category</i>&nbsp;<b></b></td>
													<td><i>Subcategory</i>&nbsp;<b></b></td>													
												</tr>
											</table>
											<hr>
                                            Description
                                ...
                                <!-- </div>
								<div id="R2" style="display:block"> -->
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" data-parent="#accordion" href="#Req2">
												<table width="100%">
													<tr>
														<td><i class="fa fa-tasks fa-fw"></i>Request#</td>
														<td><i class="fa fa-calendar fa-fw"></i>Posted Date</td>
                                    ...
                                    <div id="Req2" class="panel-collapse collapse">
                                        <div class="panel-body">
											<table width="100%">
												<tr>
													<td><i>Category</i>&nbsp;<b></b></td>
                                ...
                                <!-- </div>
								<div id="R3" style="display:block"> -->
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" data-parent="#accordion" href="#Req3">
												<table width="100%">
													<tr>
														<td><i class="fa fa-tasks fa-fw"></i>Request#</td>
														<td><i class="fa fa-calendar fa-fw"></i>Posted Date</td>
                                    ...
                                    <div id="Req3" class="panel-collapse collapse">
                                        <div class="panel-body">
											<table width="100%">
												<tr>
													<td><i>Category</i>&nbsp;<b></b></td>
                                ...
                                <!-- </div>
								<div id="R4" style="display:block"> -->
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" data-parent="#accordion" href="#Req4">
												<table width="100%">
													<tr>
														<td><i class="fa fa-tasks fa-fw"></i>Request#</td>
														<td><i class="fa fa-calendar fa-fw"></i>Posted Date</td>
                                    ...
                                    <div id="Req4" class="panel-collapse collapse">
                                        <div class="panel-body">
											<table width="100%">
												<tr>
													<td><i>Category</i>&nbsp;<b></b></td>
                                ...
                                <!-- </div>
								<div id="R5" style="display:block"> -->
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" data-parent="#accordion" href="#Req5">
												<table width="100%">
													<tr>
														<td><i class="fa fa-tasks fa-fw"></i>Request#</td>
														<td><i class="fa fa-calendar fa-fw"></i>Posted Date</td>
                                    ...
                                    <div id="Req5" class="panel-collapse collapse">
                                        <div class="panel-body">
											<table width="100%">
												<tr>
													<td><i>Category</i>&nbsp;<b></b></td>
