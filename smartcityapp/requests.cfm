...
<cfscript>
	qryReq = CreateObject("component","cfc.request").GetUserRequest(userId = session.user.user_id);
</cfscript>
    <!--  wrapper -->
    <div id="wrapper">
        <!-- navbar top -->
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">My Posts/Requests</h1>
                </div>
                 <!-- end  page header -->
            </div>
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            User Name:	Count:	Pending:	CLosed:
                        </div>
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
										<cfoutput query="qryReq">
											<cfif qryReq.CurrentRow MOD 2 EQ 0>
											...
											<tr class="odd gradeX">
												...
												<td>#dateFormat(POST_DATE, 'dd/mm/yyyy')# #TimeFormat(POST_DATE,'HH:MM:SS')#</td>
												<td>#STATUS#</td>
												<td>#NO_OF_SUPPORT#</td>
												<td>3</td>
												<td>#CATEGORY_RANK#</td>
